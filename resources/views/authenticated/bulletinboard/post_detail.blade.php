...
<div class="modal js-modal">
    ...
    <div class="modal__content">
        <form action="{{ route('post.edit') }}" method="post" id="postEdit">
            <div class="w-100">
                <div class="modal-inner-title w-50 m-auto">
                    <input type="text" name="post_title" placeholder="タイトル" class="w-100" form="postEdit">
                    @if($errors->first('post_title'))
                    <span class="error_message">{{ $errors->first('post_title') }}</span>
                    @endif
                </div>
                <div class="modal-inner-body w-50 m-auto pt-3 pb-3">
                    <textarea placeholder="投稿内容" name="post_body" class="w-100" form="postEdit"></textarea>
