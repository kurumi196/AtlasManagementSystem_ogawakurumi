        ...
        <div class="w-100 vh-100 d-flex" style="align-items:center; justify-content:center;">
            <div class="w-25 vh-75 border p-3">
                <div class="register_form">
                    ...
                    <!-- <span class="help-block">{{$errors->first('over_name')}}</span>
                    <span class="help-block">{{$errors->first('under_name')}}</span> -->
                    ...
                    <!-- <span class="help-block">{{$errors->first('over_name_kana')}}</span>
                    <span class="help-block">{{$errors->first('under_name_kana')}}</span> -->
                    ...
                    <!-- <span class="help-block">{{$errors->first('mail_address')}}</span> -->
